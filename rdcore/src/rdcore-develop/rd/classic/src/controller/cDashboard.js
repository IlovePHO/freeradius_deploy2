    ...
    init: function() {
        ...
        this.control(
            {           
			    ...
			    'tpDashboard #cStaInfos' : {
				    activate	: function(pnl){
				        me.application.runAction('cStaInfos','Index',pnl);
				    }
			    },
			    'tpDashboard #cRealms' : {
				    activate	: function(pnl){
			    ...
			    'tpDashboard #cIdps' : {
				    activate	: function(pnl){
				        me.application.runAction('cIdps','Index',pnl);
				    }
			    }, 
			    'tpDashboard #cExternalApiKeys' : {
				    activate	: function(pnl){
				        me.application.runAction('cExternalApiKeys','Index',pnl);
				    }
			    }, 
			    'tpDashboard #cEncodingSchemes' : {
				    activate	: function(pnl){
				        me.application.runAction('cEncodingSchemes','Index',pnl);
				    }
			    }, 
			    'tpDashboard #cStaConfigs' : {
				    activate	: function(pnl){
				        me.application.runAction('cStaConfigs','Index',pnl);
				    }
			    }, 
			    ...
			    'tpDashboard #cProxies' : {
				    activate	: function(pnl){
				        me.application.runAction('cProxies','Index',pnl);
				    }
			    },
                'tpDashboard #cProxyDecisionConditions' : {
				    activate	: function(pnl){
				        me.application.runAction('cProxyDecisionConditions','Index',pnl);
				    }
			    },
			    'tpDashboard #cAttributeConverts' : {
				    activate	: function(pnl){
				        me.application.runAction('cAttributeConverts','Index',pnl);
				    }
			    },
			    'tpDashboard #cNas' : {
				    activate	: function(pnl){
			    ...
			    'tpDashboard #cWireguardServers' : {
				    activate	: function(pnl){
				        me.application.runAction('cWireguardServers','Index',pnl);
				    }
			    },
			    ...
			    //VPN
			    'tpDashboard #cSoftEtherVpnInstances' : {
				    activate	: function(pnl){
				        me.application.runAction('cSoftEtherVpnInstances','Index',pnl);
				    }
			    },
			    'tpDashboard #cSoftEtherVirtualHubs' : {
				    activate	: function(pnl){
				        me.application.runAction('cSoftEtherVirtualHubs','Index',pnl);
				    }
			    },
			    'tpDashboard #cSoftEtherLocalBridges' : {
				    activate	: function(pnl){
				        me.application.runAction('cSoftEtherLocalBridges','Index',pnl);
				    }
			    },
			    'tpDashboard #cSoftEtherL2tp' : {
				    activate	: function(pnl){
				        me.application.runAction('cSoftEtherL2tp','Index',pnl);
				    }
			    },
			    'tpDashboard #cSoftEtherWireguard' : {
				    activate	: function(pnl){
				        me.application.runAction('cSoftEtherWireguard','Index',pnl);
				    }
			    },
			    'tpDashboard #cSoftEtherNetworkBridges' : {
				    activate	: function(pnl){
				        me.application.runAction('cSoftEtherNetworkBridges','Index',pnl);
				    }
			    },
    ...
    onSettingsSubmit: function(button){
        ...
        form.submit({
            ...
            success: function(a,b,c) {
                ...
                if( b.result.data.language ){
                    Local.setLanguage({
                        code: b.result.data.language,
                        ss: b.result.data.sel_language
                   });
                }
