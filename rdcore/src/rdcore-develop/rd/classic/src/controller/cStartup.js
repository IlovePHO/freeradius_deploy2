...
Ext.define('Rd.controller.cStartup', {
	...
	actionIndex: function(){
        var me          = this,
        ss = me.application.getSelLanguage() || Rd.config.selLanguage;
        
        me.application.setSelLanguage(ss); //We hardcode the language since it is not very efficient to store the phrases in DB
        Ext.Ajax.setExtraParams({
			'sel_language': me.application.getSelLanguage(),
			'language_code': Local.languageCode //現在UI言語コード("ja"または"ja_JP")
		});
