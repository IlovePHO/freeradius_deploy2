Ext.define('Rd.view.staConfigs.gridStaConfigRealms', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.gridStaConfigRealms',
    stateful: true,
    stateId: 'StateGridStaConfigRealms',
    ...
    config: {
        ...
        urlList: '/cake3/rd_cake/realms/index-ap-create.json',
        urlEdit: '/cake3/rd_cake/sta-configs/edit-realms.json',
    },
    listeners: {
            ...
            success: function (response) {
                ...
                if (jsonData.success) {
                    if (jsonData.data.user_id) {
                        me.ap_id = jsonData.data.user_id;
                        me.getStore().getProxy().setExtraParam('ap_id', me.ap_id);
                    }
                    if (jsonData.data.realms) {
                        me.selected = jsonData.data.realms;
                        me.getStore().load();
                    }
                }
            }
