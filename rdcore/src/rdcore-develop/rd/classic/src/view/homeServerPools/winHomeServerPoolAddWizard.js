Ext.define('Rd.view.homeServerPools.winHomeServerPoolAddWizard', {
    extend:     'Ext.window.Window',
    alias :     'widget.winHomeServerPoolAddWizard',
    closable:   true,
    draggable:  true,
    resizable:  true,
    title:      i18n ('sNew_Home_server_pool'),
    width:      500,
    height:     470,
    plain:      true,
    border:     false,
    ...
    initComponent: function() {
        ...
        me.setTitle( i18n('sNew_Home_server_pool') );
