...
Ext.define('Rd.view.treeTags.vcPnlTreeTagMap', {
    extend  : 'Ext.app.ViewController',
    alias   : 'controller.vcPnlTreeTagMap',
    config: {
        ...
        UrlMapDelete            : '/cake3/rd_cake/tree-tags/map-delete.json',
        UrlMapSave              : '/cake3/rd_cake/tree-tags/map-save.json',
    }, 
	...
	addMarker: function(record){
        ...
        var lat = record.get('center_lat');
        var lng = record.get('center_lng');
	    ...
	    Ext.Ajax.request({
            ...
            success: function(response){
                ...
                if(jsonData.success){     
                    ...
                    var tt = me.getView().up('pnlTreeAndMap').down('treeTreeTags');
                    var record = tt.getStore().getById(me.lastDragId);
                    record.set('center_lat',me.lastLat);
                    record.set('center_lng',me.lastLng);
                }   
            },
            scope: me
        });
	    ...
	    Ext.Ajax.request({
            ...
            success: function(response){
                ...
                if(jsonData.success){     
					...
					var tt = me.getView().up('pnlTreeAndMap').down('treeTreeTags');
                    var record = tt.getStore().getById(me.lastDragId);
                    record.set('center_lat',0);
                    record.set('center_lng',0);
                }   
            },
            scope: me
        });    
