     ...
     initComponent: function(){
        ...
        me.columns  = [
            ...
            },
            {
                ...
                dataIndex   : 'email',
                tdCls       : 'gridTree',
                filter      : {type: 'string'}, stateId: 'StateTreeAccessProviders6'
            },
            { 
                text        : i18n('sActive'),  
            ...
            { 
                ...
                flex        : 1,
                filter      : {type: 'date',dateFormat: 'Y-m-d'},
                stateId		: 'StateTreeAccessProviders9'
            },
            { 
                text    : i18n('sNotes'),
                sortable: false,
                ...
                dataIndex: 'notes', stateId: 'StateTreeAccessProviders10'
            },
            //*** Add an actioncolumn (xype : actioncolumn)
            {
                ...
                text        : 'Actions',
                width       : 80,
                stateId     : 'StateTreeAccessProviders11', //*** (Take the stateId of the last column and add 1 (12+1=13)
                items       : [				
