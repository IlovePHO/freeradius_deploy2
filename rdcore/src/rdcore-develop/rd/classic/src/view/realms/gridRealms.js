Ext.define('Rd.view.realms.gridRealms' ,{
    ...
    initComponent: function(){
        ...
        me.menu_grid = new Ext.menu.Menu({
            items: [
                { text: i18n('sGraphs'), glyph: Rd.config.icnGraph,   handler: function(){
                     me.fireEvent('menuItemClick',me,'graph'); 
                }},
                { text: i18n('sEdit Logo'),  glyph: Rd.config.icnCamera,  handler: function(){
        ...
        me.columns  = [
           // {xtype: 'rownumberer',stateId: 'StateGridRealms1'},
            ...
            { 
                dataIndex: 'proxy_names',
                text        : i18n('sActive_proxys'),
                stateId     : 'StateGR21',
                flex        : 1,
                sortable: false,
