...
Ext.define('Rd.view.meshOverview.vcPnlMeshOverview', {
    extend  : 'Ext.app.ViewController',
    alias   : 'controller.vcPnlMeshOverview',
    ...
    onClickViewButton: function(button){
        var me = this;
        var selCount = me.getView().down('gridMeshOverview').getSelectionModel().getCount();
        if(selCount == 0){
             Ext.ux.Toaster.msg(
            ...
            if(selCount > 1){
                ...
                var sr      = me.getView().down('gridMeshOverview').getSelectionModel().getLastSelected();
                var id      = sr.getId();
