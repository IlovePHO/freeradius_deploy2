...
class AppendAccessProvidersRecords2 extends AbstractMigration
{
    public function up()
    {
        $keys_table = [
            'GoogleWsLinks' => [
                'synchronize', 'callback', 'listOrgunits', 'getOrgunit',
                'listOrgunitMembers', 'listUsers', 'getUser', 'getUserinfoMe',
            ],
            'SubGroups' => [
                'index', 'add', 'delete', 'edit',
            ],
            'Idps' => [
                'index', 'add', 'delete', 'edit',
            ],
