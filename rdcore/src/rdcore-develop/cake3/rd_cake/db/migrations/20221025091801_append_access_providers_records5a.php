...
class AppendAccessProvidersRecords5a extends AbstractMigration
{
    public function up()
    {
        $keys_table = [
            'SoftEtherL2tp' => [
                'view', 'save', 'getVirtualHubList',
            ],
            'SoftEtherLocalBridges' => [
                'index', 'add', 'delete', 'getVirtualHubList', 'getDeviceList',
            ],
            'SoftEtherNetworkBridges' => [
                'index', 'add', 'editStatus', 'editAddress', 'edit', 'delete', 
                'indexInterfaces', 'addInterfaces', 'deleteInterfaces',
                'getInterfaceList',
            ],
            'SoftEtherSecureNats' => [
                'view', 'save',
            ...
            'SoftEtherVirtualHubs' => [
                'index', 'add', 'edit', 'delete',
            ],
            'SoftEtherVpnInstances' => [
                'index', 'add', 'edit', 'delete', 'synchronize',
            ],
            'SoftEtherWireguard' => [
                'view', 'save', 'indexPublicKey', 'addPublicKey',
                'deletePublicKey', 'getVirtualHubList', 'getUserList',
            ],
        ];

        $this->appendAccessControllObject($keys_table, false);
    }
