...
//        }
        ...
        if(isset($this->request->query['filter'])){
            ...
            foreach($filter as $f){ 
                ...
                if($f->operator == 'like'){
                    ...
                    }elseif($f->property == 'sub_group_name'){ //For PermanentUsers
                        array_push($where_clause,array("SubGroups.name LIKE" => '%'.$f->value.'%'));
                    }else{
        ...
        if(isset($this->request->query['query'])){
            ...
            if($query !== '[null]'){
                if($model == 'PermanentUsers'){
                    ...
                    array_push($where_clause,[$model.".nasname LIKE" => '%'.$query.'%']);
                }else{
    ...
    private function _ap_filter_for_aps($query,$user,$where_clause){
        ...
        array_push($where_clause,array('Groups.name' => $group_name ));
