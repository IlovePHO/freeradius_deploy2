...
class AliveController extends AppController {

    public $main_model      = 'Alive';
    public $base            = "Access Providers/Controllers/Alive/";
    ...
    public function index(){
        ...
        if(null !== $this->request->getQuery('dynamic_client_id')){
            ...
            if($ent_cl){
                ...
                $query->where(["Alive.nasid" => $ent_cl->nasidentifier]);
        ...
        foreach($q_r as $ent){  
            ...
            array_push($items, [
                ...
                'rband'     => $ent->rband,  
                'time'      => $ent->time->setTimezone($timezone),
                'country'   => $ent->country,
            ]);
