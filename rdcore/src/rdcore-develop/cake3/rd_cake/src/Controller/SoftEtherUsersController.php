...
class SoftEtherUsersController extends AppController {

    public $main_model       = 'SoftEtherUsers';
    public $base    = "Access Providers/Controllers/SoftEtherUsers/";
...
// public method
    ...
    public function index() {
        ...
        $query = $this->{$this->main_model}->find()->where(['hub_id' => $this->request->query['virtual_hub_id']]);
    ...
    public function menuForGrid(){
        ...
        $menu = $this->GridButtons->returnButtons($user, false, 'SoftEtherUsers');
