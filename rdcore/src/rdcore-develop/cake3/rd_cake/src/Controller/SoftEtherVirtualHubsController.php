...
class SoftEtherVirtualHubsController extends AppController {

    public $main_model       = 'SoftEtherVirtualHubs';
    public $base    = "Access Providers/Controllers/SoftEtherVirtualHubs/";
...
// public method
    ...
    public function menuForGrid(){
        ...
        $menu = $this->GridButtons->returnButtons($user, false, 'SoftEtherVirtualHubs');
