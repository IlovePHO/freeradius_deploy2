...
class AcosRightsController extends AppController{
    ...
    public function indexSm(){
        //Return the default rights of the Site Manager group which is under the 'Site Managers' branch of the tree
        ...
        //Get the id of the SM Group

        $this->Groups   = TableRegistry::get('Groups');
        $g_q            = $this->Groups->find()->where(['Groups.name' => Configure::read('group.sm')])->first();
        $group_id       = $g_q->id;
