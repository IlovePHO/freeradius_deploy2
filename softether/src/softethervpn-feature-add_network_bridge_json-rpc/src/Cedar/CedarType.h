...
typedef struct RPC_HELLO_WORLD RPC_HELLO_WORLD;
typedef struct RPC_ECHO RPC_ECHO;
...
typedef struct RPC_NETWORK_BRIDGE RPC_NETWORK_BRIDGE;
typedef struct RPC_NETWORK_BRIDGE_IF RPC_NETWORK_BRIDGE_IF;
typedef struct RPC_NETWORK_BRIDGE_ADDR RPC_NETWORK_BRIDGE_ADDR;
typedef struct RPC_NETWORK_BRIDGE_ROUTE RPC_NETWORK_BRIDGE_ROUTE;
