...
// Interface of Network Bridge
struct RPC_NETWORK_BRIDGE_IF
{
 	char BridgeName[128];
...
// Address of Network Bridge
struct RPC_NETWORK_BRIDGE_ADDR
{
 	char BridgeName[128];
	char BridgeIpAddress[64];
	char BridgeSubnetMask[64];
	char *CommandResult;
	int ExitStatus;
};

// Route of Network Bridge
struct RPC_NETWORK_BRIDGE_ROUTE
{
 	char BridgeName[128];
	char BridgeDstAddress[64];
	char BridgeDstSubnetMask[64];
	char *CommandResult;
	int ExitStatus;
};
...
UINT ScHelloWorld(RPC *r, RPC_HELLO_WORLD *t);
UINT ScEcho(RPC *r, RPC_ECHO *t);
...
UINT ScCreateBridge(RPC *r, RPC_NETWORK_BRIDGE *t);
UINT ScDeleteBridge(RPC *r, RPC_NETWORK_BRIDGE *t);
UINT ScGetBridge(RPC *r, RPC_NETWORK_BRIDGE *t);
UINT ScEnumBridge(RPC *r, RPC_NETWORK_BRIDGE *t);
UINT ScSetUpBridge(RPC *r, RPC_NETWORK_BRIDGE *t);
UINT ScSetDownBridge(RPC *r, RPC_NETWORK_BRIDGE *t);
UINT ScAddInterface(RPC *r, RPC_NETWORK_BRIDGE_IF *t);
UINT ScRemoveInterface(RPC *r, RPC_NETWORK_BRIDGE_IF *t);
UINT ScGetInterfaceList(RPC *r, RPC_NETWORK_BRIDGE_IF *t);
UINT ScAddBridgeAddress(RPC *r, RPC_NETWORK_BRIDGE_ADDR *t);
UINT ScDeleteBridgeAddress(RPC *r, RPC_NETWORK_BRIDGE_ADDR *t);
UINT ScAddBridgeRoute(RPC *r, RPC_NETWORK_BRIDGE_ROUTE *t);
UINT ScDeleteBridgeRoute(RPC *r, RPC_NETWORK_BRIDGE_ROUTE *t);
UINT ScGetBridgeRoute(RPC *r, RPC_NETWORK_BRIDGE_ROUTE *t);
