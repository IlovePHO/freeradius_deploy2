...
PACK *AdminDispatch(RPC *rpc, char *name, PACK *p)
{
	...
	DECLARE_RPC_EX("HelloWorld", RPC_HELLO_WORLD, StHelloWorld, InRpcHelloWorld, OutRpcHelloWorld, FreeRpcHelloWorld)
	DECLARE_RPC_EX("Echo", RPC_ECHO, StEcho, InRpcEcho, OutRpcEcho, FreeRpcEcho)
	...
	DECLARE_RPC_EX("CreateBridge", RPC_NETWORK_BRIDGE, StCreateBridge, InRpcNetworkBridge, OutRpcNetworkBridge, FreeRpcNetworkBridge)
	DECLARE_RPC_EX("DeleteBridge", RPC_NETWORK_BRIDGE, StDeleteBridge, InRpcNetworkBridge, OutRpcNetworkBridge, FreeRpcNetworkBridge)
	DECLARE_RPC_EX("GetBridge", RPC_NETWORK_BRIDGE, StGetBridge, InRpcNetworkBridge, OutRpcNetworkBridge, FreeRpcNetworkBridge)
	DECLARE_RPC_EX("EnumBridge", RPC_NETWORK_BRIDGE, StEnumBridge, InRpcNetworkBridge, OutRpcNetworkBridge, FreeRpcNetworkBridge)
	DECLARE_RPC_EX("SetUpBridge", RPC_NETWORK_BRIDGE, StSetUpBridge, InRpcNetworkBridge, OutRpcNetworkBridge, FreeRpcNetworkBridge)
	DECLARE_RPC_EX("SetDownBridge", RPC_NETWORK_BRIDGE, StSetDownBridge, InRpcNetworkBridge, OutRpcNetworkBridge, FreeRpcNetworkBridge)
	DECLARE_RPC_EX("AddInterface", RPC_NETWORK_BRIDGE_IF, StAddInterface, InRpcNetworkBridgeIF, OutRpcNetworkBridgeIF, FreeRpcNetworkBridgeIF)
	DECLARE_RPC_EX("RemoveInterface", RPC_NETWORK_BRIDGE_IF, StRemoveInterface, InRpcNetworkBridgeIF, OutRpcNetworkBridgeIF, FreeRpcNetworkBridgeIF)
	DECLARE_RPC_EX("GetInterfaceList", RPC_NETWORK_BRIDGE_IF, StGetInterfaceList, InRpcNetworkBridgeIF, OutRpcNetworkBridgeIF, FreeRpcNetworkBridgeIF)
	DECLARE_RPC_EX("AddBridgeAddress", RPC_NETWORK_BRIDGE_ADDR, StAddBridgeAddress, InRpcNetworkBridgeAddr, OutRpcNetworkBridgeAddr, FreeRpcNetworkBridgeAddr)
	DECLARE_RPC_EX("DeleteBridgeAddress", RPC_NETWORK_BRIDGE_ADDR, StDeleteBridgeAddress, InRpcNetworkBridgeAddr, OutRpcNetworkBridgeAddr, FreeRpcNetworkBridgeAddr)
	DECLARE_RPC_EX("AddBridgeRoute", RPC_NETWORK_BRIDGE_ROUTE, StAddBridgeRoute, InRpcNetworkBridgeRoute, OutRpcNetworkBridgeRoute, FreeRpcNetworkBridgeRoute)
	DECLARE_RPC_EX("DeleteBridgeRoute", RPC_NETWORK_BRIDGE_ROUTE, StDeleteBridgeRoute, InRpcNetworkBridgeRoute, OutRpcNetworkBridgeRoute, FreeRpcNetworkBridgeRoute)
	DECLARE_RPC_EX("GetBridgeRoute", RPC_NETWORK_BRIDGE_ROUTE, StGetBridgeRoute, InRpcNetworkBridgeRoute, OutRpcNetworkBridgeRoute, FreeRpcNetworkBridgeRoute)
...
DECLARE_SC_EX("HelloWorld", RPC_HELLO_WORLD, ScHelloWorld, InRpcHelloWorld, OutRpcHelloWorld, FreeRpcHelloWorld)
DECLARE_SC_EX("Echo", RPC_ECHO, ScEcho, InRpcEcho, OutRpcEcho, FreeRpcEcho)
...
DECLARE_SC_EX("CreateBridge", RPC_NETWORK_BRIDGE, ScCreateBridge, InRpcNetworkBridge, OutRpcNetworkBridge, FreeRpcNetworkBridge)
DECLARE_SC_EX("DeleteBridge", RPC_NETWORK_BRIDGE, ScDeleteBridge, InRpcNetworkBridge, OutRpcNetworkBridge, FreeRpcNetworkBridge)
DECLARE_SC_EX("GetBridge", RPC_NETWORK_BRIDGE, ScGetBridge, InRpcNetworkBridge, OutRpcNetworkBridge, FreeRpcNetworkBridge)
DECLARE_SC_EX("EnumBridge", RPC_NETWORK_BRIDGE, ScEnumBridge, InRpcNetworkBridge, OutRpcNetworkBridge, FreeRpcNetworkBridge)
DECLARE_SC_EX("SetUpBridge", RPC_NETWORK_BRIDGE, ScSetUpBridge, InRpcNetworkBridge, OutRpcNetworkBridge, FreeRpcNetworkBridge)
DECLARE_SC_EX("SetDownBridge", RPC_NETWORK_BRIDGE, ScSetDownBridge, InRpcNetworkBridge, OutRpcNetworkBridge, FreeRpcNetworkBridge)
DECLARE_SC_EX("AddInterface", RPC_NETWORK_BRIDGE_IF, ScAddInterface, InRpcNetworkBridgeIF, OutRpcNetworkBridgeIF, FreeRpcNetworkBridgeIF)
DECLARE_SC_EX("RemoveInterface", RPC_NETWORK_BRIDGE_IF, ScRemoveInterface, InRpcNetworkBridgeIF, OutRpcNetworkBridgeIF, FreeRpcNetworkBridgeIF)
DECLARE_SC_EX("GetInterfaceList", RPC_NETWORK_BRIDGE_IF, ScGetInterfaceList, InRpcNetworkBridgeIF, OutRpcNetworkBridgeIF, FreeRpcNetworkBridgeIF)
DECLARE_SC_EX("AddBridgeAddress", RPC_NETWORK_BRIDGE_ADDR, ScAddBridgeAddress, InRpcNetworkBridgeAddr, OutRpcNetworkBridgeAddr, FreeRpcNetworkBridgeAddr)
DECLARE_SC_EX("DeleteBridgeAddress", RPC_NETWORK_BRIDGE_ADDR, ScDeleteBridgeAddress, InRpcNetworkBridgeAddr, OutRpcNetworkBridgeAddr, FreeRpcNetworkBridgeAddr)
DECLARE_SC_EX("AddBridgeRoute", RPC_NETWORK_BRIDGE_ROUTE, ScAddBridgeRoute, InRpcNetworkBridgeRoute, OutRpcNetworkBridgeRoute, FreeRpcNetworkBridgeRoute)
DECLARE_SC_EX("DeleteBridgeRoute", RPC_NETWORK_BRIDGE_ROUTE, ScDeleteBridgeRoute, InRpcNetworkBridgeRoute, OutRpcNetworkBridgeRoute, FreeRpcNetworkBridgeRoute)
DECLARE_SC_EX("GetBridgeRoute", RPC_NETWORK_BRIDGE_ROUTE, ScGetBridgeRoute, InRpcNetworkBridgeRoute, OutRpcNetworkBridgeRoute, FreeRpcNetworkBridgeRoute)
...
// HelloWorld RPC function
UINT StHelloWorld(ADMIN *a, RPC_HELLO_WORLD *t)
{
	return ERR_NO_ERROR;
}

// RPC_HELLO_WORLD
void InRpcHelloWorld(RPC_HELLO_WORLD *t, PACK *p)
{
	Zero(t, sizeof(RPC_HELLO_WORLD));
}
void OutRpcHelloWorld(PACK *p, RPC_HELLO_WORLD *t)
{
	PackAddStr(p, "HelloWorld", "HelloWorld");
}
void FreeRpcHelloWorld(RPC_HELLO_WORLD *t)
{
}

// Echo RPC function
UINT StEcho(ADMIN *a, RPC_ECHO *t)
{
	return ERR_NO_ERROR;
}

// RPC_ECHO
void InRpcEcho(RPC_ECHO *t, PACK *p)
{
	Zero(t, sizeof(RPC_ECHO));
	PackGetStr(p, "Input", t->String, sizeof(t->String));
}
void OutRpcEcho(PACK *p, RPC_ECHO *t)
{
	PackAddStr(p, "Output", t->String);
}
void FreeRpcEcho(RPC_ECHO *t)
{
}
...
// CreateBridge RPC function
UINT StCreateBridge(ADMIN *a, RPC_NETWORK_BRIDGE *t)
{
	int ret;
	const char *path = "/usr/sbin/ip";
	char *command_argv[10] = {"ip", "-j", "link", "add", "name", t->BridgeName, "type", "bridge", NULL};
	size_t stdout_buffer_len = 1024;
	size_t stdout_buffer_count = 0;
	t->CommandResult = calloc(sizeof(*t->CommandResult), stdout_buffer_len);
	if (t->CommandResult == NULL)
		return ERR_INTERNAL_ERROR;

	ret = CommonExecCommand(path, command_argv, t->CommandResult, &stdout_buffer_count, stdout_buffer_len);
...
// DeleteBridge RPC function
UINT StDeleteBridge(ADMIN *a, RPC_NETWORK_BRIDGE *t)
{
	int ret;
	const char *path = "/usr/sbin/ip";
	char *command_argv[10] = {"ip", "-j", "link", "delete", t->BridgeName, "type", "bridge", NULL};
	size_t stdout_buffer_len = 1024;
	size_t stdout_buffer_count = 0;
	t->CommandResult = calloc(sizeof(*t->CommandResult), stdout_buffer_len);
	if (t->CommandResult == NULL)
...
// GetBridge RPC function
UINT StGetBridge(ADMIN *a, RPC_NETWORK_BRIDGE *t)
{
	// validate arguments
	int ret;
	const char *path = "/usr/sbin/ip";
	char *command_argv[10] = {"ip", "-j", "addr", "show", "type", "bridge", "dev", t->BridgeName, NULL};
	size_t stdout_buffer_len = 1024;
	size_t stdout_buffer_count = 0;
	t->CommandResult = calloc(sizeof(*t->CommandResult), stdout_buffer_len);
	if (t->CommandResult == NULL)
	...
	while (true)
	{
		...
		if (stdout_buffer_len >= 10000)
		{
			ret = -1;
			break;
		}

		free(t->CommandResult);
	...
	t->ExitStatus = ret;
	Debug("[CommandResult]: %s\n", t->CommandResult);
	Debug("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n\n");

	return ERR_NO_ERROR;
}

// EnumBridge RPC function
UINT StEnumBridge(ADMIN *a, RPC_NETWORK_BRIDGE *t)
{
	int ret;
	const char *path = "/usr/sbin/ip";
	char *command_argv[10] = {"ip", "-j", "link", "show", "type", "bridge", NULL};
	size_t stdout_buffer_len = 1024;
	size_t stdout_buffer_count = 0;
	t->CommandResult = calloc(sizeof(*t->CommandResult), stdout_buffer_len);
	if (t->CommandResult == NULL)
...
// SetUpBridge RPC function
UINT StSetUpBridge(ADMIN *a, RPC_NETWORK_BRIDGE *t)
{
	int ret;
	const char *path = "/usr/sbin/ip";
	char *command_argv[10] = {"ip", "-j", "link", "set", t->BridgeName, "up", NULL};
	size_t stdout_buffer_len = 1024;
	size_t stdout_buffer_count = 0;
	t->CommandResult = calloc(sizeof(*t->CommandResult), stdout_buffer_len);
	if (t->CommandResult == NULL)
...
// SetDownBridge RPC function
UINT StSetDownBridge(ADMIN *a, RPC_NETWORK_BRIDGE *t)
{
	int ret;
	const char *path = "/usr/sbin/ip";
	char *command_argv[10] = {"ip", "-j", "link", "set", t->BridgeName, "down", NULL};
	size_t stdout_buffer_len = 1024;
	size_t stdout_buffer_count = 0;
	t->CommandResult = calloc(sizeof(*t->CommandResult), stdout_buffer_len);
	if (t->CommandResult == NULL)
...
// AddInterface RPC function
UINT StAddInterface(ADMIN *a, RPC_NETWORK_BRIDGE_IF *t)
{
	int ret;
	const char *path = "/usr/sbin/ip";
	char *command_argv[10] = {"ip", "-j", "link", "set", t->InterfaceName, "master", t->BridgeName, NULL};
	size_t stdout_buffer_len = 1024;
	size_t stdout_buffer_count = 0;
	t->CommandResult = calloc(sizeof(*t->CommandResult), stdout_buffer_len);
	if (t->CommandResult == NULL)
...
// RemoveInterface RPC function
UINT StRemoveInterface(ADMIN *a, RPC_NETWORK_BRIDGE_IF *t)
{
	int ret;
	const char *path = "/usr/sbin/ip";
	char *command_argv[10] = {"ip", "-j", "link", "set", t->InterfaceName, "nomaster", NULL};
	size_t stdout_buffer_len = 1024;
	size_t stdout_buffer_count = 0;
	t->CommandResult = calloc(sizeof(*t->CommandResult), stdout_buffer_len);
	if (t->CommandResult == NULL)
...
// GetInterfaceList RPC function
UINT StGetInterfaceList(ADMIN *a, RPC_NETWORK_BRIDGE_IF *t)
{
	int ret;
	const char *path = "/usr/sbin/ip";
	char *command_argv[10] = {"ip", "-j", "link", "show", "master", t->BridgeName, NULL};
	size_t stdout_buffer_len = 1024;
	size_t stdout_buffer_count = 0;
	t->CommandResult = calloc(sizeof(*t->CommandResult), stdout_buffer_len);
	if (t->CommandResult == NULL)
...
// AddBridgeAddress RPC function
UINT StAddBridgeAddress(ADMIN *a, RPC_NETWORK_BRIDGE_ADDR *t)
{
	if (IsIpStr4(t->BridgeIpAddress) == false || IsIpStr4(t->BridgeSubnetMask) == false)
		return ERR_INVALID_PARAMETER;

	if (IsSubnetMask32(StrToIP32(t->BridgeSubnetMask)) == false)
		return ERR_INVALID_PARAMETER;

	char BridgeNetworkAddress[256];
	sprintf(BridgeNetworkAddress, "%s/%s", t->BridgeIpAddress, t->BridgeSubnetMask);

	int ret;
	const char *path = "/usr/sbin/ip";
	char *command_argv[10] = {"ip", "-j", "addr", "add", BridgeNetworkAddress, "dev", t->BridgeName, NULL};
	size_t stdout_buffer_len = 1024;
	size_t stdout_buffer_count = 0;
	t->CommandResult = calloc(sizeof(*t->CommandResult), stdout_buffer_len);
	if (t->CommandResult == NULL)
...
// DeleteBridgeAddress RPC function
UINT StDeleteBridgeAddress(ADMIN *a, RPC_NETWORK_BRIDGE_ADDR *t)
{
	if (IsIpStr4(t->BridgeIpAddress) == false || IsIpStr4(t->BridgeSubnetMask) == false)
		return ERR_INVALID_PARAMETER;
	...
	int ret;
	const char *path = "/usr/sbin/ip";
	char *command_argv[10] = {"ip", "-j", "addr", "del", BridgeNetworkAddress, "dev", t->BridgeName, NULL};
	size_t stdout_buffer_len = 1024;
	size_t stdout_buffer_count = 0;
	t->CommandResult = calloc(sizeof(*t->CommandResult), stdout_buffer_len);
	if (t->CommandResult == NULL)
...
// AddBridgeRoute RPC function
UINT StAddBridgeRoute(ADMIN *a, RPC_NETWORK_BRIDGE_ROUTE *t)
{
	if (IsIpStr4(t->BridgeDstAddress) == false || IsIpStr4(t->BridgeDstSubnetMask) == false)
		return ERR_INVALID_PARAMETER;

	if (IsSubnetMask32(StrToIP32(t->BridgeDstSubnetMask)) == false)
		return ERR_INVALID_PARAMETER;

	char BridgeNetworkDstAddress[256];
	sprintf(BridgeNetworkDstAddress, "%s/%s", t->BridgeDstAddress, t->BridgeDstSubnetMask);

	int ret;
	const char *path = "/usr/sbin/ip";
	char *command_argv[10] = {"ip", "-j", "route", "add", BridgeNetworkDstAddress, "dev", t->BridgeName, NULL};
	size_t stdout_buffer_len = 1024;
	size_t stdout_buffer_count = 0;
	t->CommandResult = calloc(sizeof(*t->CommandResult), stdout_buffer_len);
	if (t->CommandResult == NULL)
...
// DeleteBridgeRoute RPC function
UINT StDeleteBridgeRoute(ADMIN *a, RPC_NETWORK_BRIDGE_ROUTE *t)
{
	if (IsIpStr4(t->BridgeDstAddress) == false || IsIpStr4(t->BridgeDstSubnetMask) == false)
		return ERR_INVALID_PARAMETER;
	...
	int ret;
	const char *path = "/usr/sbin/ip";
	char *command_argv[10] = {"ip", "-j", "route", "del", BridgeNetworkDstAddress, "dev", t->BridgeName, NULL};
	size_t stdout_buffer_len = 1024;
	size_t stdout_buffer_count = 0;
	t->CommandResult = calloc(sizeof(*t->CommandResult), stdout_buffer_len);
	if (t->CommandResult == NULL)
...
// GetBridgeRoute RPC function
UINT StGetBridgeRoute(ADMIN *a, RPC_NETWORK_BRIDGE_ROUTE *t)
{
	int ret;
	const char *path = "/usr/sbin/ip";
	char *command_argv[10] = {"ip", "-j", "route", "show", "dev", t->BridgeName, NULL};
	size_t stdout_buffer_len = 1024;
	size_t stdout_buffer_count = 0;
	t->CommandResult = calloc(sizeof(*t->CommandResult), stdout_buffer_len);
	if (t->CommandResult == NULL)
...
// Get Time Difference
float DiffTimespec(struct timespec time1, struct timespec time2)
{
	return time2.tv_sec - time1.tv_sec +
		(float)(time2.tv_nsec - time1.tv_nsec)/1000000000;
}

// Copy String Buffer
static int CopyStringBuffer(char* dst_buffer, size_t* dst_buffer_count, size_t dst_buffer_len, const char* src_buffer, size_t src_buffer_len)
{
	if (dst_buffer == NULL ||
	    src_buffer == NULL ||
	    dst_buffer_count == NULL) {
		printf("argument error");
		return -1;
	}

	if (dst_buffer_len - *dst_buffer_count <= 1) {
		printf("dst_buffer exhausted error\n");
		return -2;
	} else if (dst_buffer_len - *dst_buffer_count > src_buffer_len) {
		memcpy(dst_buffer + *dst_buffer_count, src_buffer,
			src_buffer_len);
		*dst_buffer_count += src_buffer_len;
		return 0;
	} else {
		memcpy(dst_buffer + *dst_buffer_count, src_buffer,
			dst_buffer_len - *dst_buffer_count - 1);
		*dst_buffer_count = dst_buffer_len - 1;
		return 0;
	}
}

// Run a command safely and return its result
// return -1ではなくreturn NULLのほうがよいのではないか
// NULLと0が判別されるか
// remove_empty_string_from_argv
int CommonExecCommand(const char *path, char *argv[], char *stdout_buffer, size_t *stdout_buffer_count, size_t stdout_buffer_len)
{
	int status = 0;
	int i, ret;
	int pfd[2] = {};
	...
	if (pid < 0) {
		...
		// clear stdout_buffer
		if (stdout_buffer && stdout_buffer_count) {
			memset(stdout_buffer, 0, stdout_buffer_len);
			*stdout_buffer_count = 0;
		}

		// waitpid Timeout
		do {
			if (sigtimedwait(&mask, NULL, &timeout2) < 0) {
				if (errno == EINTR) {
					// Interrupted by a signal other than SIGCHLD.
					continue;
				} else if (errno == EAGAIN) {
					Debug("(%ld) Timeout, killing child\n", time(0));
					kill(pid, SIGKILL);
				} else {
					Debug("(%ld) sigtimedwait\n", time(0));
					return -1;
				}
			}
			break;
		...
		while (true) {
			...
			if (waitpid(pid, &status, 0) < 0) {
				Debug("(%ld) WIFEXITED: %d\n", time(0), WIFEXITED(status));
				Debug("(%ld) WEXITSTATUS: %d\n", time(0), WEXITSTATUS(status));
				Debug("(%ld) Done from parent\n", time(0));
				return -1;
			}
			...
			if (fabs(DiffTimespec(now, start)) > 6 && !send_sigkill) {
				kill(pid, SIGKILL);
				send_sigkill = 1;
				usleep(500000);
				continue;
			} else if (fabs(DiffTimespec(now, start)) > 3 && !send_sigterm) {
				kill(pid, SIGTERM);
				send_sigterm = 1;
				usleep(500000);
				continue;
			...
			if (read_ret > 0) {
				ret = select(pfd[PIPE_READ]+1, &set, NULL, NULL, &timeout);
				if (ret < 0) {
					read_ret = -1;
					continue;
				} else if (ret == 0) {
				...
				read_ret = read(pfd[PIPE_READ], buffer, sizeof(buffer)-1);
				if (read_ret > 0 && stdout_buffer &&
				    stdout_buffer_count && copy_ret == 0) {
					copy_ret = CopyStringBuffer(stdout_buffer,
						stdout_buffer_count,
						stdout_buffer_len, buffer, read_ret);
				}
			}
		}
...
// Run a command safely and return its result (Buffer extension available)
int CommonExecCommandEx(const char *path, char *argv[], char *stdout_buffer, size_t *stdout_buffer_count, size_t stdout_buffer_len)
{
	/* int ret;
	...
	{
		Debug("[stdout_buffer_len]: %d\n", stdout_buffer_len);
		ret = CommonExecCommand(path, argv, stdout_buffer, stdout_buffer_count, stdout_buffer_len);
		Debug("[ret]: %d\n", ret);
		Debug("[stdout_buffer]: %s\n", stdout_buffer);
		...
		*stdout_buffer_count = 0;
		...
		stdout_buffer = calloc(sizeof(*stdout_buffer), stdout_buffer_len);
...
// RPC_NETWORK_BRIDGE
void InRpcNetworkBridge(RPC_NETWORK_BRIDGE *t, PACK *p)
{
	// Validate arguments
	if (t == NULL || p == NULL)
	{
	...
	Zero(t, sizeof(RPC_NETWORK_BRIDGE));
	PackGetStr(p, "BridgeName", t->BridgeName, sizeof(t->BridgeName));
}
void OutRpcNetworkBridge(PACK *p, RPC_NETWORK_BRIDGE *t)
{
	// Validate arguments
	if (t == NULL || p == NULL)
	{
	...
	PackAddStr(p, "BridgeName", t->BridgeName);
	PackAddData(p, "CommandResult", t->CommandResult, StrLen(t->CommandResult));
	PackAddInt(p, "ExitStatus", t->ExitStatus);
}
void FreeRpcNetworkBridge(RPC_NETWORK_BRIDGE *t)
{
	// Validate arguments
	if (t == NULL)
	{
...
// RPC_NETWORK_BRIDGE_IF
void InRpcNetworkBridgeIF(RPC_NETWORK_BRIDGE_IF *t, PACK *p)
{
	// Validate arguments
	if (t == NULL || p == NULL)
	{
	...
	Zero(t, sizeof(RPC_NETWORK_BRIDGE));
	PackGetStr(p, "BridgeName", t->BridgeName, sizeof(t->BridgeName));
	PackGetStr(p, "InterfaceName", t->InterfaceName, sizeof(t->InterfaceName));
}
void OutRpcNetworkBridgeIF(PACK *p, RPC_NETWORK_BRIDGE_IF *t)
{
	// Validate arguments
	if (t == NULL || p == NULL)
	{
	...
	PackAddStr(p, "BridgeName", t->BridgeName);
	PackAddStr(p, "InterfaceName", t->InterfaceName);
	PackAddData(p, "CommandResult", t->CommandResult, StrLen(t->CommandResult));
	PackAddInt(p, "ExitStatus", t->ExitStatus);
}
void FreeRpcNetworkBridgeIF(RPC_NETWORK_BRIDGE_IF *t)
{
	// Validate arguments
	if (t == NULL)
	{
...
// RPC_NETWORK_BRIDGE_ADDR
void InRpcNetworkBridgeAddr(RPC_NETWORK_BRIDGE_ADDR *t, PACK *p)
{
	// Validate arguments
	if (t == NULL || p == NULL)
	{
	...
	Zero(t, sizeof(RPC_NETWORK_BRIDGE));
	PackGetStr(p, "BridgeName", t->BridgeName, sizeof(t->BridgeName));
	PackGetStr(p, "BridgeIpAddress", t->BridgeIpAddress, sizeof(t->BridgeIpAddress));
	PackGetStr(p, "BridgeSubnetMask", t->BridgeSubnetMask, sizeof(t->BridgeSubnetMask));
}
void OutRpcNetworkBridgeAddr(PACK *p, RPC_NETWORK_BRIDGE_ADDR *t)
{
	// Validate arguments
	if (t == NULL || p == NULL)
	{
	...
	PackAddStr(p, "BridgeName", t->BridgeName);
	PackAddStr(p, "BridgeIpAddress", t->BridgeIpAddress);
	PackAddStr(p, "BridgeSubnetMask", t->BridgeSubnetMask);
	PackAddData(p, "CommandResult", t->CommandResult, StrLen(t->CommandResult));
	PackAddInt(p, "ExitStatus", t->ExitStatus);
}
void FreeRpcNetworkBridgeAddr(RPC_NETWORK_BRIDGE_ADDR *t)
{
	// Validate arguments
	if (t == NULL)
	{
...
// RPC_NETWORK_BRIDGE_ROUTE
void InRpcNetworkBridgeRoute(RPC_NETWORK_BRIDGE_ROUTE *t, PACK *p)
{
	// Validate arguments
	if (t == NULL || p == NULL)
	{
	...
	Zero(t, sizeof(RPC_NETWORK_BRIDGE));
	PackGetStr(p, "BridgeName", t->BridgeName, sizeof(t->BridgeName));
	PackGetStr(p, "BridgeDstAddress", t->BridgeDstAddress, sizeof(t->BridgeDstAddress));
	PackGetStr(p, "BridgeDstSubnetMask", t->BridgeDstSubnetMask, sizeof(t->BridgeDstSubnetMask));
}
void OutRpcNetworkBridgeRoute(PACK *p, RPC_NETWORK_BRIDGE_ROUTE *t)
{
	// Validate arguments
	if (t == NULL || p == NULL)
	{
	...
	PackAddStr(p, "BridgeName", t->BridgeName);
	PackAddStr(p, "BridgeDstAddress", t->BridgeDstAddress);
	PackAddStr(p, "BridgeDstSubnetMask", t->BridgeDstSubnetMask);
	PackAddData(p, "CommandResult", t->CommandResult, StrLen(t->CommandResult));
	PackAddInt(p, "ExitStatus", t->ExitStatus);
}
void FreeRpcNetworkBridgeRoute(RPC_NETWORK_BRIDGE_ROUTE *t)
{
	// Validate arguments
	if (t == NULL)
	{
